    ...
    <>
        <div className='grid grid-cols-2 pb-24'>
            <div className='py-12 col-span-2 lg:col-span-1 border-devarana-graph border-r-[.5px] border-t lg:border-b border-b-[1px]'>
                    <p className='text-devarana-graph text-center pb-5 font-playfair lg:text-2xl text-lg'> ¡Síguenos en nuestras redes! </p>
            ...
            <div className='py-12 col-span-2 lg:col-span-1  border-devarana-graph border-r-[.5px] lg:border-t border-b border-t-border-b-[1px]'>
                <p className='text-devarana-graph text-center pb-5 font-playfair lg:text-2xl text-lg'>¿Cómo llegar a showroom?</p>
                <div className='flex justify-center gap-x-20'>
