...
export const Menu = () => {
    ...
    <>
        <div className='fixed h-[60px] w-full items-center flex lg:justify-between lg:px-36 px-10 z-50'>
            ...
            <div id='menu' className='menu__container top-0 fixed w-full lg:max-w-[515px] bg-devarana-blue  lg:bg-opacity-80 flex justify-center items-center z-[1000] transition-all duration-200'>
