                ...
                <div className='grid grid-cols-12 pb-10'>
                    ...
                    <div className='lg:col-span-6 col-span-12'>
                        <div className='mx-auto lg:max-w-sm'>
                            <p className='text-white font-playfair text-left lg:text-[22px] leading-8 text-sm'>Somos creadores, arquitectos <br className='lg:block hidden' /> y diseñadores de lo extraordinario.</p>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div className='grid grid-cols-12 pt-10'>
                        <div className='lg:col-start-5 lg:col-span-3 flex flex-col gap-10 col-span-12'>
                            <div>
                                <p className='text-white font-extrabold lg:text-2xl text-base pb-3'>VENTAS</p>
                            ...
                            <div>
                                <p className='text-white font-extrabold lg:text-2xl text-base pb-3'>CORPORATIVO</p>
                            ...
                            <div>
                                <p className='text-white font-extrabold lg:text-2xl text-base pb-3'>CAPITAL HUMANO</p>
                            ...
                            <div>
                                <p className='text-white font-extrabold lg:text-2xl text-base pb-3'>COMPRAS</p>
                        ...
                        <div className='lg:col-span-3 flex flex-col gap-10 col-span-12 lg:pt-0 pt-10'>
                            <div>
                                <p className='text-white font-extrabold lg:text-2xl text-base pb-3'>VISÍTANOS</p>
                                <p className='text-white font-extralight block lg:text-xl text-sm'>Av. Valle de Acantha 88, Fracc. Zibatá, Sección Acantha, C.P. 76269, El Marqués, Querétaro. </p>
                            </div>
                            ...
                            <div className='flex flex-col h-full gap-y-11'>
                                ...
                                <div className='flex gap-16 justify-center -translate-x-10'>
