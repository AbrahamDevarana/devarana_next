  ...
  return (
    <>
        ...
        <div className="lg:object-center md:object-top object-bottom hidden"/>
            ...
            <h3 className="text-devarana-graph-darker text-3xl relative p-8 pb-0 text-left group-hover:-translate-y-[436px] group-hover:opacity-1 group-hover:text-white overflow-hidden z-20" style={{ transition: 'all 1s cubic-bezier(0.33, 0, 0.13, 1)' }}>
            ...
            <div className="relative mt-2 z-20 px-8 text-left group-hover:text-white group-hover:-translate-y-[436px] opacity-0 group-hover:opacity-100" style={{ transition: 'all 1s cubic-bezier(0.33, 0, 0.13, 1)' }}>
                <Link href={url}>
                    <span className="text-devarana-graph-darker group-hover:text-white flex items-center gap-x-2 hover:opacity-50" style={{ transition: 'all 1s cubic-bezier(0.33, 0, 0.13, 1)' }}>Ver más <RightArrowSvg className='fill-white w-[20px] stroke-white'/></span>
                </Link>
            </div>
            <div className="mt-2 pb-10 px-8 group-hover:-translate-y-[30px] opacity-100 group-hover:opacity-0" style={{ transition: 'all 1s cubic-bezier(0.33, 0, 0.13, 1)' }}>
                <div className="opacity-100 translate-x-0 translate-y-0">
                    <p className='text-devarana-graph'> { description } </p>
                </div>
            </div>
