  ...
  return (
    <>
		...
		<div className='relative py-24'>
			...
			<div className='text-center max-w-3xl mx-auto py-20 tracking-wide text-lg'>
			...
			<div className='grid grid-cols-2'>
				<div className='col-span-1 relative ml-[215px]'>
				...
				<div className='col-span-1 flex items-center'>
					<div>
						<h2 className='text-4xl font-playfair text-devarana-midnight font-medium pb-10 pl-20'>¿Por qué DEVARANA?</h2>
		...
		<div className='bg-devarana-blue h-[300px] text-devarana-pink' />

		<div className='py-[100px]'>
			<h2 className='text-center font-playfair devarana-graph-darker text-6xl'>Proyecto Actual</h2>
			<hr className='border-devarana-pink w-72 mb-[50px] mt-[35px] mx-auto'/>
			<p className='text-center font-light text-devarana-graph'>Descubre Royal View, para ti que inviertes en elegancia, seguridad y un entorno exclusivo.</p>
		</div>

		<div className='px-[245px]'>
			<div className="grid grid-cols-3">
				<div className='col-span-1'>
					<h3 className='text-center pb-20 devarana-graph-darker text-[40px] font-playfair'>Torre Terra</h3>
					...
					<p className='px-14 text-devarana-graph'>La mezcla perfecta entre garantía en la calidad, seguridad e inversión.</p>
				</div>
				<div className='col-span-1 border-r border-l'>
					<h3 className='text-center pb-20 devarana-graph-darker text-[40px] font-playfair'>Torre Aqua</h3>
					<div className='mx-10 relative'>
						<div className='absolute h-[112%] -top-6 left-0 right-0 mx-5 bottom-0 bg-devarana-hazelnut bg-opacity-70 -z-10 rounded-sm' />
					...
					<p className='px-14 text-devarana-graph'>Con más de 30 amenidades para ti y tu familia.</p>
				</div>
				<div className='col-span-1'>
					<h3 className='text-center pb-20 devarana-graph-darker text-[40px] font-playfair'>Torre Fuego</h3>
					<div className='mx-10 relative'>
						<div className='absolute h-[112%] -top-6 left-0 right-0 mx-5 bottom-0 bg-devarana-hazelnut bg-opacity-70 -z-10 rounded-sm' />
					...
					<p className='px-14 text-devarana-graph'>Garantía en calidad, seguridad y plusvalía.</p>
				</div>
			</div>
